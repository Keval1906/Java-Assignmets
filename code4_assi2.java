/*(Subclasses of Account) In Programming Exercise 2, the Account class was defined 
...
for the classes and then implement them. Write a test program that creates objects of 
Account, SavingsAccount, and CheckingAccount and invokes their toString() 
methods.
Created by ---> Keval R. Hadiyal    */
import java.util.*;
class Account 
{
    private int id = 0;
